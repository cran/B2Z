GIBBSB2zm <- function (NUpd, burnin, lag, initial, priors, S, v, 
    ...
    r <- .Call("call_gibbs", y, times, funct, rtol, atol, rho,              
         ...
         as.integer(total_it), PACKAGE = "B2Z")
    ...
    ESS <- c(effectiveSize(Beta),effectiveSize(Q), effectiveSize(G))
